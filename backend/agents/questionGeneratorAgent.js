...
async function generateQuestionsLLM(params) {
  ...
  const prompt = `
You are an interview coach. Generate ${count} ${qtype} questions on "${topic}" for a ${targetRole}, for day ${day} of this roadmap: ${roadmap}.
...
If MCQ, include "choices". If not, omit.
